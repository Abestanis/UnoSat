...
/** Data for the LOCATION message. */
typedef struct PACKED {
    /** The CPU time this telemetry was generated. */
    ms_t time;
    /** The last known latitude of the system. */
    deg_t latitude;
    /** The last known longitude of the system. */
    deg_t longitude;
    /** The last known altitude of the system. */
    mm_t altitude;
...
typedef struct PACKED {
    ...
    TelemetryMessageHeader header;
    /** The message data. */
    TelemetryLocationData data;
} TelemetryLocationType;
...
bool sendTelemetryLocation(ms_t time, deg_t latitude, deg_t longitude, mm_t altitude,
    uint8_t visibleSatellites) {
    size_t messageSize = sizeof(TelemetryLocationType);
