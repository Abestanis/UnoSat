 ...
 */
extern bool sendTelemetryData(ms_t time, deg_t latitude, deg_t longitude, mm_t attitude,
    uint8_t visibleSatellites, celsius_t temperature, percent_t humidity, pascal_t pressure);
